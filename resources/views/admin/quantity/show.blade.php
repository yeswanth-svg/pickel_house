                ...
                <div class="col-lg-8 offset-lg-2">
                    <div class="card shadow border-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label class="fs-5 fw-bold text-primary">Original Price</label>
                                    <p class="text-dark border rounded px-3 py-2">
                                        ₹{{ number_format($dish->original_price, 2) }}</p>
                                </div>
                                <div class="col-md-6">
                                    <label class="fs-5 fw-bold text-primary">Discount Price</label>
                                    <p class="text-dark border rounded px-3 py-2">
                                        ₹{{ number_format($dish->discount_price, 2) }}</p>
                                </div>
                                <div class="col-md-6">
