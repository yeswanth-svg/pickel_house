...
@section('title', 'Packing Orders List')
@section('content')
...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">Packing Orders</h3>
            <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                    <a href="#">Packing Orders</a>
                </li>
                <li class="separator">
                    <i class="icon-arrow-right"></i>
                </li>
                <li class="nav-item">
                    <a href="#">All Packing Orders</a>
                </li>
            </ul>
        </div>
        <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h4 class="card-title">Packing Orders</h4>
                        </div>
                    </div>
                    <div class="card-body">
