                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('admin.dishes.update', $dish->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="price" id="price" class="form-control"
                                        placeholder="e.g., Chicken Biryani" value="{{$dish->price}}">
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="dish_tag" id="dish_tag" class="form-select" required>
                                        <option value="popular" {{ $dish->dish_tag == 'popular' ? 'selected' : '' }}>
                                            Popular</option>
                                        <option value="most_ordered" {{ $dish->dish_tag == 'most_ordered' ? 'selected' : '' }}>
                                            Most Ordered
                                        </option>
                                        <option value="latest" {{ $dish->dish_tag == 'latest' ? 'selected' : '' }}>
                                            Latest
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="mt-4">
                                ...
                                <a href="{{ route('admin.dishes.index') }}" class="btn btn-secondary ml-2">Cancel</a>
                            </div>
                    </div>
